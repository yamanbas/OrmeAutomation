<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="OrmeAutomation.Default" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server" >
    ...
    <div id="content" class="app-content">
			...
			<!-- BEGIN row -->
			<div class="row">
	<asp:DataList ID="machineView" runat="server" RepeatColumns="8"  RepeatDirection="Horizontal">
        <ItemTemplate>
